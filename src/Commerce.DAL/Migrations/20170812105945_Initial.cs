        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherModule = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSpend = table.Column<decimal>(nullable: false),
                    ...
                    multipleUse = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherType = table.Column<string>(maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketVouchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketVouchers_Baskets_BasketId",
                        column: x => x.BasketId,
                        principalTable: "Baskets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketVouchers_BasketId",
                table: "BasketVouchers",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketVouchers_VoucherId",
                table: "BasketVouchers",
                column: "VoucherId");
